      ...
      <main id="main" className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h1 className="text-3xl md:text-5xl font-display text-ink mb-6">
              Our Blog
            </h1>
            <p className="text-base md:text-xl text-ink-muted max-w-3xl mx-auto">
          ...
          {posts.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h2 className="text-2xl font-display text-ink mb-4">No blogs at the moment</h2>
              <p className="text-sm md:text-lg text-ink-muted max-w-md mx-auto">
                  ...
                  <div className="flex-1 p-6 flex flex-col justify-between">
                    <div className="flex-1">
                      <div className="block mt-2">
                        <h2 className="text-xl font-semibold text-ink mb-3 line-clamp-2">
                          {post.title}
                        </h2>
                    ...
                    <div className="mt-4 pt-4 border-t border-ink/10">
                      <div className="flex items-center justify-between">
                        ...
                        <button className="text-teal hover:text-teal-dark font-semibold text-sm transition-colors duration-200">
                          Read More →
                        </button>
                      </div>
                    </div>
